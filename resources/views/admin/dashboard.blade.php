                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-visual" data-aos="fade-left" data-aos-delay="150">
                            <img src="assets/img/services/{{ optional($services->get(5))->content ?? '' }}" alt="Services"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-lg-center">
                    <div class="col-lg-5 order-lg-2" data-aos="fade-left" data-aos-delay="200">
                        <div class="image-wrapper position-relative">
                            <img src="assets/img/cta/{{ optional($ctas->get(2))->content ?? '' }}" alt="CTA Visual"
                    ...
                    <div class="col-lg-6 offset-lg-1 order-lg-1" data-aos="fade-right" data-aos-delay="100">
                        <div class="content-area">
                            ...
                            <div class="cta-wrapper">
                                <a href="#" class="btn btn-cta">Daftar</a>
                            </div>
                        </div>
                    </div>
