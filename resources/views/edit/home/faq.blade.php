              ...
              <div class="card-body p-4 p-lg-5">
                ...
                <form action="{{ route('postLogin') }}" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="600">
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-12">
                      <p>Edit Faq Title</p>
                      <input type="text" name="HomeFaqTitle" class="form-control" placeholder="Penerimaan Mahasiswa Baru 2025/2026" required="">
                    </div>
                    ...
                    <div class="col-12 ">
                      ...
                      <input type="text" class="form-control" name="homeFaqContent" placeholder="2200+" required="">
                    </div>
