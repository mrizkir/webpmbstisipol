...
<head>
    ...
    <title>Hero - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('updateHomeHero') }}" method="post" class="php-email-form"
...
<div class="stat-item">
  <div class="col-12">
    ...
    <input type="text" class="form-control" name="stats[${index}][number]" placeholder="0000+">
  </div>
  <div class="col-12">
    <input type="text" class="form-control" name="stats[${index}][label]" placeholder="label">
    <button type="button" class="hapusStats btn btn-danger">Hapus</button>
  </div>
</div>
`;
