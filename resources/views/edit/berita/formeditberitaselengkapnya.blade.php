...
<head>
    ...
    <title>Edit Berita Selengkapnya - Admin PMB SITISIPOL Raja Haji</title>
...
<body class="index-page">
    ...
    <div class="row gy-4">
        @foreach ($berita as $beritas)
            <div class="berita-item border p-3 mb-3 rounded">
                <input type="hidden" name="beritas[{{ $loop->index }}][id]" value="{{ $beritas->id }}">

                <div class="col-12 mb-2">
                    <p>Edit Judul Berita</p>
                    <input type="text"
                           value="{{ $beritas->judul }}"
                           name="beritas[{{ $loop->index }}][judul]"
                           class="form-control"
                ...
                <div class="col-12 mb-2">
                    ...
                    <input type="file"
                           name="beritas[{{ $loop->index }}][img]"
                           class="form-control">
                </div>

                <button type="button" class="hapusBeritas btn btn-danger mt-2">Hapus</button>
            </div>
        @endforeach
    ...
    document.addEventListener("click", function(e) {
        if (e.target.classList.contains("hapusBeritas")) {
            e.preventDefault();
            ...
            if (beritaIdInput) {
                ...
                hiddenInput.name = "deleteBeritas[]";
