...
<head>
    ...
    <title>Tambah Data Alur Pendaftaran - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('tambahMegamenuAlurPendaftaran') }}" method="post" class="php-email-form" enctype="multipart/form-data"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="tahap" class="form-control"
                                                placeholder="Masukkan Tahap" required>
                                        </div>
                                        <div class="col-12">
