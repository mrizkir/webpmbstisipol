...
<head>
    ...
    <title>Home-STISIPOL Raja Haji</title>
...
<body class="index-page">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu" style="padding-left: 20vw">
                <ul>
                    ...
                    <li>
                        <a id="daftar" href="https://portal.stisipolrajahaji.ac.id/register" target="_blank" onmouseover="this.style.boxShadow='1px 1px 30px #023047';this.style.color='#fff';this.style.border='none';this.querySelector('span').style.visibility='visible';this.querySelector('span').style.transform='scale(100) translateX(2px)';"
    ...
    <main class="main">
                    ...
                    <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right" data-aos-delay="200">
                        <div class="hero-content">
                            ...
                            <div class="hero-actions">
                                <a href="https://portal.stisipolrajahaji.ac.id/register" class="btn-primary">Daftar Sekarang</a>
        ...
        <section id="features" class="features section">
           ...
           <!-- Section Title -->
            <div class="container section-title" data-aos="fade-up">
                <span class="description-title">Program Studi</span>
                <h2>Program Studi</h2>
            </div><!-- End Section Title -->
                    ...
                    <div class="col-lg-6 offset-lg-1 order-lg-1" data-aos="fade-right" data-aos-delay="100">
                        <div class="content-area">
                            ...
                            <div class="cta-wrapper">
                                <a href="https://portal.stisipolrajahaji.ac.id/register" class="btn btn-cta">Daftar</a>
                            </div>
                        </div>
                    </div>
