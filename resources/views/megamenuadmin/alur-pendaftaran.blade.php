...
<body class="index-page">
            ...
            <section id="alur-image" class="alur-image section text-center mt-5 mb-5">
                <div class="container" data-aos="fade-up">
                    <div class="alur-frame border rounded-4 shadow-lg p-3">
                        <img src="../assets/img/lainnya/pendaftaran/{{ $alurpendaftarans[0]->tahap}}"
                            alt="Alur Pendaftaran Online STISIPOL Raja Haji" class="img-fluid rounded-3"
                            style="max-width: 50%; height: auto;">
                    </div>
                    <a href="{{ route('showupdateMegamenuAlurPendaftaranGambar', $alurpendaftarans[0]->id) }}" class="btn-tambah p-2"><p>Update Konten</p></a>
                </div>
            </section>
            <!-- /Alur Pendaftaran Image Section -->
                    ...
                    <div class="tab-pane fade show active" id="schedule-tab-pane-1" role="tabpanel"
                        ...
                        <div class="schedule-content">
                            <div class="session-timeline">
                                @foreach ($alurpendaftarans->skip(1) as $alurpendaftaran)
                               <div class="session-block">
                                    <div class="session-time">
                                        <span class="start">{{ $alurpendaftaran->tahap }}</span>
                                    </div>
                                    <div class="session-card {{ $alurpendaftaran->background }}">
                                        <div class="session-info">
                                            <h3 class="session-title">{{$alurpendaftaran->deskripsi}}
                                            </h3>
                                        </div>

                                    </div>
                                    <a href="{{ route('showupdateMegamenuAlurPendaftaran', $alurpendaftaran->id) }}" class="btn-tambah p-2"><p>Update Konten</p></a>
                                    <form action="{{ route('hapusMegamenuAlurPendaftaran', $alurpendaftaran->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger">Hapus</button>
            ...
            <a href="{{ route('editMegamenuAlurPendaftaranTambah') }}" class="btn-tambah">Tambah Konten</a>
            </div>
