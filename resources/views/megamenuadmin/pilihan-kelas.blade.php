                                    ...
                                    <div class="content-grid">
                                        <div class="product-section">
                                            <div class="product-list">
                                                <a href="{{ route(name: 'admin.konsentrasi') }}" class="product-link">
                    ...
                    <!-- First row with two larger cards -->
                     ...
                     <div class="col-lg-6" data-aos="flip-left" data-aos-delay="100">
                         <div class="feature-card">
                             ...
                             <a href="{{ route('showupdateMegamenuPilihanKelas', $pilihankelas->id) }}" class="btn-tambah"><p>Update Konten</p></a>
                             <form action="{{ route('hapusMegamenuPilihanKelas', $pilihankelas->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
    @csrf
    @method('DELETE')
...
<a href="{{ route('editMegamenuPilihanKelasTambah') }}" class="btn-tambah">Tambah Konten</a>
            </div>
