...
<body class="index-page">
                ...
                <ul>
                    ...
                    <li class="megamenu-2"><a href="#"><span>Lainnya</span> <i
                        ...
                        <ul class="mobile-megamenu">
                            ...
                            <li><a href="#"><span>Beasiswa</span></a>
                            </li>
                    ...
                    <li><a href="{{ route('admin.downloads') }}" class="active">Download</a></li>

                    <li>
                        <a id="daftar" href="https://portalstisipolrajahaji.ac.id/index.php?page=Pendaftaran" target="_blank"
    ...
    <main class="main">
        ...
        <!-- Features Section -->
        <section id="features-beasiswa" class="features-beasiswa section">
            @if(session('success'))
          ...
          <script>
            ...
            <div class="container section-title mt-5" data-aos="fade-up">
                <span class="description-title">Beasiswa</span>
                <h2>Beasiswa</h2>
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#features-tab-{{ $beasiswa->id }}">
                                <h4>{{ $beasiswa->tombol }}</h4>
                            </a>
                        </li><!-- End tab nav item -->
                        @endforeach
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    @foreach ($beasiswas as $beasiswa) 
                    <div class="tab-pane fade" id="features-tab-{{ $beasiswa->id }}">
                        <div class="row">
                            <div
                                ...
                                <a href="{{ route('showupdateMegamenuBeasiswa', $beasiswa->id) }}" class="btn-tambah"><p>Update Konten</p></a>
                                <form action="{{ route('hapusMegamenuBeasiswa', $beasiswa->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger">Hapus</button>
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="../assets/img/beasiswa/{{ $beasiswa->img }}" alt="" class="img-fluid">
                            </div>
                        </div>
...
<a href="{{ route('editMegamenuBeasiswaTambah') }}" class="btn-tambah">Tambah Konten</a>
            </div>
