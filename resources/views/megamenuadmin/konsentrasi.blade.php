...
<body class="index-page">
                ...
                <ul>
                    ...
                    <li class="megamenu-2"><a href="#"><span>Lainnya</span> <i
                        ...
                        <ul class="mobile-megamenu">
                            ...
                            <li class="dropdown"><a href="{{ route('admin.beasiswa') }}"><span>Beasiswa</span></a>
                            </li>
        ...
        <section id="featured-programs" class="featured-programs section ">
          ...
          <script>
            ...
            @foreach ($konsentrasis as $konsentrasi)
                <div class="container mb-4 {{ $konsentrasi->background_card }}-background" data-aos="fade-up" data-aos-delay="100">
                <div class="row gy-5">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                        <div class="program-banner">
                            <div class="banner-image">
                                <img src="../assets/img/konsentrasi/{{ $konsentrasi->img }}" alt="Program" class="img-fluid">
                            
                            </div>
                            <div class="banner-info">
                                <div class="program-header">
                                    <h3>{{ $konsentrasi->judul }}</h3>
                                   
                                </div>
                                <p>{{ $konsentrasi->deskripsi }}</p>
                                <div class="program-details">
                                 
                                </div>
                                <btn class="discover-btn{{ $konsentrasi->background_akreditasi }} w-100 text-center {{ $konsentrasi->background_akreditasi2 }}">{{ $konsentrasi->akreditasi }}</btn>
                            </div>
                        </div>
                        ...
                        <div class="programs-grid">
                            <div class="row g-3">
                                <div class="col-12" data-aos="fade-left" data-aos-delay="200">
                                    <div class="program-item{{ $konsentrasi->background_konsentrasi }}">
                                        <div class="item-content">
                                            <h3>{{ $konsentrasi->konsentrasi1 }}</h3>
                                            
                                           
                                        </div>
                                    </div>
                                </div>
                                @if ($konsentrasi->konsentrasi2)                                   
                                <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                                    <div class="program-item{{ $konsentrasi->background_konsentrasi }}">
                                        <div class="item-content">
                                            <h3>{{ $konsentrasi->konsentrasi2 }}</h3>
                                ...
                                @endif
                                @if ($konsentrasi->konsentrasi3)   
                                <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                                    <div class="program-item{{ $konsentrasi->background_konsentrasi }}">
                                        <div class="item-content">
                                            <h3>{{ $konsentrasi->konsentrasi3 }}</h3>
                                ...
                                @endif
                                @if ($konsentrasi->konsentrasi4)   
                                <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                                    <div class="program-item{{ $konsentrasi->background_konsentrasi }}">
                                        <div class="item-content">
                                            <h3>{{ $konsentrasi->konsentrasi4 }}</h3>
                                ...
                                @endif
                                @if ($konsentrasi->konsentrasi5) 
                                <div class="col-12" data-aos="fade-left" data-aos-delay="400">
                                    <div class="program-item{{ $konsentrasi->background_konsentrasi }}">
                                        <div class="item-content">
                                            <h3>{{ $konsentrasi->konsentrasi5 }}</h3>
            ...
            <a href="{{ route('showupdateMegamenuKonsentrasi', $konsentrasi->id) }}" class="btn-tambah p-2" >Update Konten</a>
            <form action="{{ route('hapusMegamenuKonsentrasi', $konsentrasi->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger">Hapus</button>
            ...
            @endforeach
             ...
             <a href="{{ route('editMegamenuKonsentrasiTambah') }}" class="btn-tambah">Tambah Konten</a>
