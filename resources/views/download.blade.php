                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <p class=" text-muted small mb-0 fw-bold">Sertifikat Akreditasi Stisipol RH 2021-2026</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-STISIPOL-RH-2021-2026.pdf"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                                        <a href="files/brosur-pmb-2025.pdf" class="btn btn-primary" download>
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2"
                                    style="width: 32px; height: 32px;">2</span>
                                    <div class="">
                                        <p class="text-muted small mb-0 fw-bold"> Sertifikat Akreditasi Program Studi Administrasi Publik 2025–2026</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/07/sertifikat-perpanjangan-ap-2025-2026.pdf"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Administrasi Publik 2020-2025</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Administrasi-Publik-2020-2025.pdf"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Administrasi Publik 2015-2020</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Administrasi-Publik-2015-2020.jpeg"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <!-- Card 5 -->
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center"><span class="badge bg-number rounded-circle d-flex align-center justify-content-center me
                                    "
                                    style="width: 32px; height: 32px;">5</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Administrasi Publik 2011-2016</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Administrasi-Publik-2015-2020-1.jpeg"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2 "
                                    style="width: 32px; height: 32px;">6</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Ilmu Pemerintahan 2025–2026</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/07/prodi-ilmu-pemerintahan_685c0cab3d2b0.pdf"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2 "
                                    style="width: 32px; height: 32px;">7</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Ilmu Pemerintahan 2020-2025</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Ilmu-Pemerintahan-2020-2025.pdf"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2 "
                                    style="width: 32px; height: 32px;">8</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Ilmu Pemerintahan 2015-2020</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Ilmu-Pemerintahan-2015-2020.jpeg"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2 "
                                    style="width: 32px; height: 32px;">9</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Sosiologi 2022-2027</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Sosiologi-2022-2027.jpeg"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
                            ...
                            <div class="card mb-3 shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <span class="badge bg-number rounded-circle d-flex align-center justify-content-center me-2 "
                                    style="width: 32px; height: 32px;">10</span>
                                    <div>
                                        <p class="text-muted small mb-0 fw-bold">Sertifikat Akreditasi Program Studi Sosiologi 2017-2022</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol lihat -->
                                        <a href="https://stisipolrajahaji.ac.id/wp-content/uploads/2025/08/Sertifikat-Akreditasi-Program-Studi-Sosiologi-2017-2022.jpeg"
                                            class="btn btn-outline-secondary" target="_blank">
                                            <i class="bi bi-eye me-1"></i> Lihat
                                        </a>
                                        <!-- Tombol download -->
